...
bridge_entries = [
    {'name': 'claude-local', 'base_url': 'http://127.0.0.1:18791', 'api_key': '', 'api_mode': 'anthropic_messages', 'model': 'ccli-sonnet'},
    {'name': 'claude-local', 'base_url': 'http://127.0.0.1:18791', 'api_key': '', 'api_mode': 'anthropic_messages', 'model': 'ccli-opus'},
    {'name': 'claude-local', 'base_url': 'http://127.0.0.1:18791', 'api_key': '', 'api_mode': 'anthropic_messages', 'model': 'ccli-haiku'},
]
# Drop any entries we've ever managed: the current `claude-local` provider name
